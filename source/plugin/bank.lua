...
{text = '• 𝖲𝗈𝗎𝗋𝖼𝖾 - HELLAS .',url="t.me/HELLASUserBot"}, 
}
}
...
{
{text = '• 𝖲𝗈𝗎𝗋𝖼𝖾 - dama .', url="t.me/sorcedamafaz3a"},
},
}
}
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@sorcedamafaz3a")
sleep(1)
