...
xname =  (Redis:get(Fast.."Name:Bot") or "براند") 
...
if idephoto then
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "براند")
...
local Lakb = Redis:get(Fast..'CustomTitle'..msg_chat_id..':'..senderr) or 0
local likes = Redis:get(Fast..'liker'..msg_chat_id..':'..senderr) or 0
local Texting = {
  "بحبك 🥺♥.!",
  "وشك دا ولا وش رجل 😂",
  "صوره قمر زي صاحبها 🥺♥.!",
...
if not msg.Special and Redis:get(Fast..'idnotmem'..msg.chat_id)  then
  local rino = '\n*✦┊'..Description..'\n✦┊الايـدي ⇜ '..UserId..'\n✦┊المعـرف ⇜ '..UserInfousername..'\n✦┊الرتبـه ⇜ '..RinkBot..'\n✦┊اللقـب ⇜ '..Lakb..'\n✦┊الرسـائل ⇜ '..TotalMsg..' - '..TotalMsgT..'\n✦┊المُعجبيـن ⇜ '..Likes..' ♥️\n✦┊السحكـات ⇜ '..TotalEdit..'\n✦┊النبـذه ⇜ '..Bio..'*'
  keyboard = {} 
  keyboard.inline_keyboard = {
  {{text = '🤍'..likes.., callback_data = '/Liikee'..senderr},},}
  local rep = msg.id/2097152/0.5
  return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' ..msg_chat_id.. '&text=' .. URL.escape(rino).."&reply_to_message_id="..rep..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))
  end
  keyboard = {} 
  keyboard.inline_keyboard = {
    {{text = '🤍'..likes.., callback_data = '/Liikee'..senderr},},}
    local rep = msg.id/2097152/0.5
  return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(Get_Is_Id).."&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&reply_to_message_id="..rep.."&parse_mode=Markdown&reply_markup="..JSON.encode(keyboard))
  else
  return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' ..msg_chat_id.. '&text=' .. URL.escape(Get_Is_Id).."&reply_to_message_id="..rep..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))
  end
  else
  if photo.total_count > 0 then
    if not msg.Special and Redis:get(Fast..'idnotmem'..msg.chat_id)  then
  ...
  keyboard.inline_keyboard = {
    {{text = '🤍'..likes.., callback_data = '/Liikee'..senderr},},}
    local rep = msg.id/2097152/0.5
  return https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg.chat_id.."&caption="..URL.escape(rino).."&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&reply_to_message_id="..rep.."&parse_mode=Markdown&reply_markup="..JSON.encode(keyboard))
  else
    local rino = '\n*✦┊'..Description..'\n✦┊الايـدي ⇜ '..UserId..'\n✦┊المعـرف ⇜ '..UserInfousername..'\n✦┊الرتبـه ⇜ '..RinkBot..'\n✦┊اللقـب ⇜ '..Lakb..'\n✦┊الرسـائل ⇜ '..TotalMsg..' - '..TotalMsgT..'\n✦┊المُعجبيـن ⇜ '..Likes..' ♥️\n✦┊السحكـات ⇜ '..TotalEdit..'\n✦┊النبـذه ⇜ '..Bio..'*'
    keyboard = {} 
  keyboard.inline_keyboard = {
  ...
  return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg_chat_id .. '&text=' .. URL.escape(rino).."&reply_to_message_id="..rep..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))
    ...
    keyboard = {} 
  keyboard.inline_keyboard = {
  {{text = '🤍 ⇜ ♥️', callback_data = '/Liikee'..senderr},},}
  local rep = msg.id/2097152/0.5
  return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg_chat_id .. '&text=' .. URL.escape(rino).."&reply_to_message_id="..rep..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))
  end
  end
...
return send(msg_chat_id,msg_id,'\n⌯ مرحبا بك في السجل المدني الخاص بسورس براند\nاكتب اسمك الان :',"md",true)  
end
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@creative179")
sleep(1)
